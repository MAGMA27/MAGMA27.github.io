---
title: Transformer语言模型架构和细节梳理
date: 2026-05-22T08:16:12.675Z
tags: [LLM]
comments: false
draft: false
summary: Transformer语言模型架构和细节梳理，个人学习笔记，请谨慎参考，如有错误欢迎指出。
category: LLM
---
...
最后用p=0.1，temperature=1，prompt = "Once upon a time there was a little boy named Ben."看下生成效果：
...
基本上还是狗屁不通，从选词平均概率、loss和perplexity看，模型仍旧是欠拟合的。
